      ...
      <div className="space-y-6">
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="text-white/30 text-sm mt-1">Satellite-based environmental intelligence assessment for {city.name}</p>
          </div>
                ...
                {showExportMenu && (
                  <div className="absolute right-0 top-full mt-2 rounded-xl shadow-2xl py-1 z-50 min-w-[180px]"
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-colors"
                    >
        ...
        {!plan && !loading && !error && (
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No Action Plan Generated</h3>
            <p className="text-white/25 text-sm max-w-md text-center mb-8">
                ...
                return (
                  ...
                  >
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                      style={{ background: isDone ? 'rgba(16,185,129,0.1)' : isActive ? 'rgba(6,182,212,0.1)' : 'rgba(255,255,255,0.03)' }}>
                      {isDone ? (
                    ...
                    <div>
                      <p className={`text-sm font-medium ${isDone ? 'text-white/30 line-through' : isActive ? 'text-white' : 'text-white/20'}`}>
                        {step.label}
                      </p>
